...
\begin{abstract}
Flow by advection and mean curvature is common in studying and modelling topology changes of surfaces.
Typically, the surfaces studies (including biological cell boundaries or growing mammalian organs) have complex morphometry and topology, meaning validation of computational models is challenging.
In this work, we present the closed-form solution of a sphere under advection and mean curvature flow
This solution may be used to validate numerical solutions for surfaces under advection and mean curvature flow. 
\end{abstract}
...
\begin{figure}[t]
  ...
  \begin{tabular}{c}
    \subfloat[$r_0 = 11, a = 1, b = 10$]{
      \includegraphics[width=0.8\linewidth]{solution_1}%
      \label{fig:solution:1}
    } \\
    \subfloat[$r_0 = 9, a = 1, b = 10$]{
      \includegraphics[width=0.8\linewidth]{solution_2}%
      \label{fig:solution:2}
    } \\
    \subfloat[$r_0 = 10, a = -1, b = 10$]{
      \includegraphics[width=0.8\linewidth]{solution_3}%
...
\label{app:python}
Source code is provided in Python since the implementation is not obvious.
